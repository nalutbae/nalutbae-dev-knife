...
import pytest
from devknife.utils.math_utility import NumberBaseConverter, HashGenerator, TimestampConverter
...
class TestHashGenerator:
    ...
    def test_generate_sha256_only(self):
        ...
        assert result.success
        assert result.output == "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"
    ...
    def test_empty_string_hash(self):
        ...
        assert result.success
        assert result.output == "d41d8cd98f00b204e9800998ecf8427e"  # MD5 of empty string
...
class TestTimestampConverter:
    ...
    def test_unix_timestamp_to_date(self):
        ...
        input_data = InputData("1640995200", InputSource.ARGS)  # 2022-01-01 09:00:00 UTC
