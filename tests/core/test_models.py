...
import pytest
from devknife.core.models import (
    Command,
    InputData,
    ProcessingResult,
    Config,
...
class TestProcessingResult:
    ...
    def test_failed_result(self):
        ...
        result = ProcessingResult(
            success=False, output=None, error_message="Processing failed"
        )
    ...
    def test_result_validation(self):
        ...
        with pytest.raises(
            ValueError, match="Error message is required when success is False"
        ):
