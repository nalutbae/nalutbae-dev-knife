...
class OutputFormatter:
    ...
    def format_output(self, data: Any, format_type: Union[str, OutputFormat] = OutputFormat.AUTO) -> str:
        """
...
class ErrorHandler:
    ...
    def handle_parsing_error(self, error: Exception, data_type: str, position: Optional[int] = None) -> ProcessingResult:
        """
    ...
    def handle_input_error(self, error: Exception, input_source: str) -> ProcessingResult:
        """
    ...
    def handle_generic_error(self, error: Exception, context: str = "operation") -> ProcessingResult:
        """
