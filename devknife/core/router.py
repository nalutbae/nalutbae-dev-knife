...
class CommandRegistry:
    ...
    def list_commands(self, category: Optional[str] = None, 
                     cli_only: bool = False, tui_only: bool = False) -> List[str]:
        """
                ...
                try:
                    ...
                    for attr_name in dir(module):
                        ...
                        if (isinstance(attr, type) and 
                            issubclass(attr, UtilityModule) and 
                            attr != UtilityModule):
...
class CommandRouter:
    ...
    def route_command(self, command_name: str, input_data: InputData, 
    ...
    def get_general_help(self) -> str:
        ...
        for category in categories:
            ...
            for command_name in commands:
                ...
                if command_info:
                    help_lines.append(f"  {command_name:<15} - {command_info.description}")
    ...
    def validate_command_options(self, command_name: str, 
